          ...
          <table class="text-12 text-muted m-0 p-2 ivas-table bigtext">
            ...
            <tbody>
              <tr>
                ...
                <td>  ₡{{ number_format( $data->book->cc_compras, 0 ) }} </td>
                <td>-</td>
              </tr>
              <tr>
                <th>Importación de bienes y servicios:</th>
                <td>  ₡{{ number_format( $data->book->cc_importaciones, 0 ) }} </td>
                <td>-</td>
              </tr>
              <tr>
                <th>Compras locales de propiedad, planta y equipo:</th>
                <td>  ₡{{ number_format( $data->book->cc_propiedades, 0 ) }} </td>
                <td>-</td>
              </tr>
              <tr>
              ...
              <tr class="total">
                <th>Total:</th>
                <td>  ₡{{ number_format( $data->book->cc_compras + $data->book->cc_importaciones + $data->book->cc_propiedades + $data->book->cc_compras_sin_derecho + $data->book->cc_iva_compras + $data->book->cc_iva_importaciones + $data->book->cc_iva_propiedades, 0 ) }} </td>
                <td>  ₡{{ number_format( $data->book->cc_proveedores_contado + $data->book->cc_proveedores_credito, 0 ) }} </td>
              </tr>
            </tbody>
