<table class="text-12 text-muted m-0 p-2 ivas-table bigtext borrador-presentacion" style="width:100%;">
	...
	<?php
		...
		$iva_compras_S1 = $impuestos['iva_compras_S1']['val'];	
		$iva_compras_S2 = $impuestos['iva_compras_S2']['val'];	
		$iva_compras_S3 = $impuestos['iva_compras_S3']['val'];	
		$iva_compras_S4 = $impuestos['iva_compras_S4']['val'];	
		$iva_importaciones_S1 = $impuestos['iva_importaciones_S1']['val'];	
		$iva_importaciones_S2 = $impuestos['iva_importaciones_S2']['val'];	
		$iva_importaciones_S3 = $impuestos['iva_importaciones_S3']['val'];	
		$iva_importaciones_S4 = $impuestos['iva_importaciones_S4']['val'];	
		$iva_compras_S1e = $impuestos['iva_compras_S1e']['val'];	
		$iva_compras_S2e = $impuestos['iva_compras_S2e']['val'];	
		$iva_compras_S3e = $impuestos['iva_compras_S3e']['val'];	
		$iva_compras_S4e = $impuestos['iva_compras_S4e']['val'];	
		$iva_importaciones_S1e = $impuestos['iva_importaciones_S1e']['val'];	
		$iva_importaciones_S2e = $impuestos['iva_importaciones_S2e']['val'];	
		$iva_importaciones_S3e = $impuestos['iva_importaciones_S3e']['val'];	
		$iva_importaciones_S4e = $impuestos['iva_importaciones_S4e']['val'];	
		$iva_compras_B1 = $impuestos['iva_compras_B1']['val'];	
		$iva_compras_B2 = $impuestos['iva_compras_B2']['val'];	
		$iva_compras_B3 = $impuestos['iva_compras_B3']['val'];	
		$iva_compras_B4 = $impuestos['iva_compras_B4']['val'];	
		$iva_importaciones_B1 = $impuestos['iva_importaciones_B1']['val'];	
		$iva_importaciones_B2 = $impuestos['iva_importaciones_B2']['val'];	
		$iva_importaciones_B3 = $impuestos['iva_importaciones_B3']['val'];	
		$iva_importaciones_B4 = $impuestos['iva_importaciones_B4']['val'];	
		$iva_compras_B1e = $impuestos['iva_compras_B1e']['val'];	
		$iva_compras_B2e = $impuestos['iva_compras_B2e']['val'];	
		$iva_compras_B3e = $impuestos['iva_compras_B3e']['val'];	
		$iva_compras_B4e = $impuestos['iva_compras_B4e']['val'];	
		$iva_importaciones_B1e = $impuestos['iva_importaciones_B1e']['val'];	
		$iva_importaciones_B2e = $impuestos['iva_importaciones_B2e']['val'];	
		$iva_importaciones_B3e = $impuestos['iva_importaciones_B3e']['val'];	
		$iva_importaciones_B4e = $impuestos['iva_importaciones_B4e']['val'];	
		$iva_bc_L1 = $impuestos['iva_bc_L1']['val'];	
		$iva_bc_L2 = $impuestos['iva_bc_L2']['val'];	
		$iva_bc_L3 = $impuestos['iva_bc_L3']['val'];	
		$iva_bc_L4 = $impuestos['iva_bc_L4']['val'];	
		$iva_bc_I1 = $impuestos['iva_bc_I1']['val'];	
		$iva_bc_I2 = $impuestos['iva_bc_I2']['val'];	
		$iva_bc_I3 = $impuestos['iva_bc_I3']['val'];	
		$iva_bc_I4 = $impuestos['iva_bc_I4']['val'];	
		$iva_bc_L1e = $impuestos['iva_bc_L1e']['val'];	
		$iva_bc_L2e = $impuestos['iva_bc_L2e']['val'];	
		$iva_bc_L3e = $impuestos['iva_bc_L3e']['val'];	
		$iva_bc_L4e = $impuestos['iva_bc_L4e']['val'];	
		$iva_bc_I1e = $impuestos['iva_bc_I1e']['val'];	
		$iva_bc_I2e = $impuestos['iva_bc_I2e']['val'];	
		$iva_bc_I3e = $impuestos['iva_bc_I3e']['val'];	
		$iva_bc_I4e = $impuestos['iva_bc_I4e']['val'];	
		$totales1 = $impuestos['totales1']['val'];	
		$totales2 = $impuestos['totales2']['val'];	
		$totales3 = $impuestos['totales3']['val'];	
		$totales4 = $impuestos['totales4']['val'];	
		$totalesSum = $impuestos['totalesSum']['val'];	
		$totales1e = $impuestos['totales1e']['val'];	
		$totales2e = $impuestos['totales2e']['val'];	
		$totales3e = $impuestos['totales3e']['val'];	
		$totales4e = $impuestos['totales4e']['val'];	
		$totalesSume = $impuestos['totalesSume']['val'];
		$totalCreditosPeriodo = $impuestos['totalCreditosPeriodo']['val'];
		$creditosAcreditablesPorTarifa = $impuestos['creditosAcreditablesPorTarifas']['val'];
