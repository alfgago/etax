            ...
            <div class="row">
                ...
                <div class="col-9">
                    <div class="tab-content p-0" id="v-pills-tabContent">
                        {!! Form::model($company,['route' => ['Company.update_company',$company->id],'method' => 'put','autocomplete' => 'off','files' => true]) !!}
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <div class="form-row">
                                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} col-md-6">
                                            ...
                                            {!! Form::text('name',$fname,['placeholder' => 'Name','id'=>'inputTestl4','class' => 'form-control']) !!}
                                        ...
                                        <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }} col-md-6 ">
                                            ...
                                            <select class="form-control" name="type" id="type_company" required >
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <div class="form-row">
                                        <div class="form-group{{ $errors->has('invoice_email') ? ' has-error' : '' }} col-md-6">
                                            ...
                                            {!! Form::text('invoice_email',$invoice_email,['placeholder' => 'Invoice Email','id'=>'inputTestl4','class' => 'form-control']) !!}
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            {!! Form::text('default_currency',$default_currency,['placeholder' => 'Default currency','id'=>'inputTestl5','class' => 'form-control']) !!}
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            {!! Form::text('neighborhood',$neighborhood,['placeholder' => 'Neighborhood','id'=>'inputTestl5','class' => 'form-control']) !!}
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <div class="form-row">
                                        <div class="form-group{{ $errors->has('user_name') ? ' has-error' : '' }} col-md-6">
                                            ...
                                            {!! Form::text('user_name',$user_name,['placeholder' => 'Usuario ATV','id'=>'inputTestl4','class' => 'form-control']) !!}
                                        ...
                                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }} col-md-6">
                                            ...
                                            {!! Form::text('password',$password,['placeholder' => 'Contraseña ATV','id'=>'inputTestl5','class' => 'form-control']) !!}
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            {!! Form::text('pin',$pin,['placeholder' => 'PIN de llave criptográfica','id'=>'inputTestl5','class' => 'form-control']) !!}
                                            @if ($errors->has('pin'))
                        ...
                        <div class=" update_button col-md-8 col-sm-8 d-flex flex-wrap">
                            <h6 class="w-100">By clicking UPDATE, you are updating your company information.</h6>
                        ...
                        <input type="hidden" id="is-company-edit" value="1">
                        ...
                        <script>
                            ...
                            if (target_tab_selector == '#v-pills-team')
                            {
                            $('.update_button').addClass('team_button');
                            }
                            else {
                            $('.update_button').removeClass('team_button');
                            }
                            });
                            });
                        </script>
