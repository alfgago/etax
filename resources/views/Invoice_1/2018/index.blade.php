...
@section('breadcrumb-buttons')
    <a class="btn btn-primary" href="/facturas-emitidas/create">Ingresar factura 2018</a>
    <div onclick="abrirPopup('importar-emitidas-2018-popup');" class="btn btn-primary">Importar facturas para prorrata 2018</div>
@endsection 
