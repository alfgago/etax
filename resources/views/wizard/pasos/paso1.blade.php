...
<div class="form-group col-md-4" style="white-space: nowrap;">
  ...
  <input type="number" class="form-control checkEmpty" name="id_number" id="id_number" value="{{ @$company->id_number }}" required onchange="getJSONCedula(this.value);" onblur="validateIdentificationLength();">
</div>
