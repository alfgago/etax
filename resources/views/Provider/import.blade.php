		  ...
		  <div class="form-group col-md-12">
			  <div class="description">
			  	...
			  	* El orden puede variar, mantener nombres de columnas. Debe utilizar una fila por cada proveedor.
			  	<br>
			  	<a href="{{asset('assets/files/PlantillaProveedores.xlsx')}}" class="btn btn-link" title="Descargar plantilla" download><i class="fa fa-file-excel-o" aria-hidden="true"></i> Descargar plantilla</a>
			  </div>
		  </div>
