	...
	public function sendHacienda($request) {
		...
		$data = [
			...
			'invoice_id' => 0,
            	...
            	'subtotal' => $request->resumenFactura['totalVentaNeta'],
            	'iva_amount' => $request->resumenFactura['totalImpuestos'],
            	'total_iva_devuelto' => $request->resumenFactura['totalIvaDevuelto'],
            	'total_iva_exonerado' => $request->resumenFactura['totalExento'],
            	'total_otros_cargos' => $request->resumenFactura['totalOtrosCargos'],
            	'total' => $request->resumenFactura['totalComprobante'],
            	...
            	'typeDocument' => $request->tipo_documento,
            	'is_catalogue' => false,
