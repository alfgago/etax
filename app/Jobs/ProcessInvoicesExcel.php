    ...
    public function handle()
    {
        try{
            ...
            try{
                ...
                //dd($client, $invoice, $request);
                //Fechas
                try{
                    $fecha = Carbon::createFromFormat('d/m/Y', $factura->fechaEmision);
                }catch( \Exception $ex ){
                    $dt =\PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject( $factura->fechaEmision );
                    $fecha = Carbon::instance($dt);
                }
                try{
                    $fechaV = Carbon::createFromFormat('d/m/Y', $factura->fechaVencimiento);
                }catch( \Exception $ex ){
                    $dt =\PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject( $factura->fechaVencimiento );
                    $fechaV = Carbon::instance($dt);
                }
