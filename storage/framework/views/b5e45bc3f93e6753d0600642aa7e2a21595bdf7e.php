		...
		<form method="POST" action="/proveedores/importar" enctype="multipart/form-data">
		  ...
		  <div class="form-group col-md-12">
			  <div class="description">
			  	Las columnas requeridas para importación de proveedores son: <br>
			  	...
			  	* El orden puede variar, mantener nombres de columnas. Debe utilizar una fila por cada proveedor.
			  	<br>
			  	<a href="<?php echo e(asset('assets/files/PlantillaProveedores.xlsx')); ?>" class="btn btn-link" title="Descargar plantilla" download><i class="fa fa-file-excel-o" aria-hidden="true"></i> Descargar plantilla</a>
			  </div>
		  </div>
		  ...
		  <div class="form-group col-md-12">
			...
			<button type="submit" class="btn btn-primary">Importar proveedores</button>
			
		</form>
  </div>
</div>
<?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/Provider/import.blade.php ENDPATH**/ ?>