<?php $__env->startSection('title'); ?> 
    Comparativo de emitidas - QuickBooks
...
<div class="row">
  <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <form method="POST" action="/quickbooks/emitidas/sync-etaxaqb" class="form-row">
            <?php echo csrf_field(); ?>
            ...
            <button id="btn-submit" type="submit" class="hidden">Guardar emitidas</button>
...
<script>
    ...
    $(function() {
      datatable = $('#dataTable').DataTable({
        ...
        serverSide: true,
        ajax: {
          url: "/quickbooks/emitidas/data-etaxaqb",
          data: function(d){
    ...
    function reloadComparativo() {
        ...
        if(tipo == 'etaxaqb'){
          window.location.replace("/quickbooks/emitidas/comparativo-etaxaqb/"+ano+"/"+mes);
        }else{
          window.location.replace("/quickbooks/emitidas/comparativo/"+ano+"/"+mes);
        }
    }
    ...
    function resyncQuickbooks() {
        Swal.fire({
            ...
            text: "Este cargará todas las facturas de Quickbooks del mes seleccionado. Puede tardar unos minutos. No es necesario hacerlo si no ha agregado clientes recientemente desde el panel de Quickbooks.",
            type: 'info',
            ...
            if (result.value) {
                var mes = $("#input-mes").val();
                var ano = $("#input-ano").val();
                window.location.replace("/quickbooks/emitidas/resync/"+ano+"/"+mes);
            }
        })
...
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/Quickbooks/Invoices/sync-qb.blade.php ENDPATH**/ ?>