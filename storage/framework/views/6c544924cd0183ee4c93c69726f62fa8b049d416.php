<?php $__env->startSection('title'); ?> 
    Comparativo de proveedores - QuickBooks
...
<div class="row">
  <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <form method="POST" action="/quickbooks/proveedores/sync-etaxaqb" class="form-row">
            <?php echo csrf_field(); ?>
...
<script>
    ...
    $(function() {
      datatable = $('#dataTable').DataTable({
        ...
        serverSide: true,
        ajax: {
          url: "/quickbooks/proveedores/data-etaxaqb",
          type: 'GET'
        },
        order: [[ 2, 'asc' ]],
        columns: [
          { data: 'link', name: 'link' },
          { data: 'id_number2', name: 'id_number' },
          { data: 'fullname2', name: 'first_name' },
    ...
    function reloadComparativo() {
        ...
        if(tipo == 'etaxaqb'){
          window.location.replace("/quickbooks/proveedores/comparativo-etaxaqb");
        }else{
          window.location.replace("/quickbooks/proveedores/comparativo");
        }
    }
    ...
    function resyncQuickbooks() {
        Swal.fire({
            ...
            text: "Este cargará todos los proveedores de Quickbooks nuevamente. Puede tardar unos minutos. No es necesario hacerlo si no ha agregado proveedores recientemente desde el panel de Quickbooks.",
            type: 'info',
            ...
            if (result.value) {
                window.location.replace("/quickbooks/proveedores/resync/");
            }
        })
...
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/Quickbooks/Providers/sync-qb.blade.php ENDPATH**/ ?>