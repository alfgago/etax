...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(mix('assets/styles/css/themes/eva.min.css')); ?>">
...
<body>
  <div class="auth-layout-wrap">
    ...
    <div class="auth-top">
       <img src="<?php echo e(asset('assets/images/top-3.png')); ?>">
    </div>
    ...
    <div class="auth-content">
        ...
        <div class="auth-logo text-center mb-4">
          <img src="<?php echo e(asset('assets/images/logo-final-150.png')); ?>" alt="">
        </div>
    ...
    <div class="auth-bottom">
       <img src="<?php echo e(asset('assets/images/bot-3.png')); ?>">
    </div>
    
  </div>
  <script src="<?php echo e(mix('assets/js/common-bundle.js')); ?>"></script>
...
</html><?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/layouts/login.blade.php ENDPATH**/ ?>