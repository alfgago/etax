		  ...
		  <div class="form-group col-md-12">
			  <div class="descripcion">
			  	...
			  	* Máximo de 2500 lineas por archivo.
			  	<br>
			  	<a href="<?php echo e(asset('assets/files/PlantillaEnvioMasivo.xlsx')); ?>" class="btn btn-link" title="Descargar plantilla" download><i class="fa fa-file-excel-o" aria-hidden="true"></i> Descargar plantilla</a>
			  </div>
		  </div>
...
<?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/Invoice/envio-masivo.blade.php ENDPATH**/ ?>