            ...
            <?php 
                ...
                foreach ($items as $item) {
                    ...
                    <li class="nav-item <?php if($i > 2){ ?> small-nav <?php } ?>" >
                        <a class="nav-item-hold" <?php echo e($item->type); ?>="<?php echo e($item->link); ?>">
                            <img src="<?php echo e(asset($item->icon)); ?>" class="sidemenu-icon">
                        ...
                        <div class="subitems">
                            ...
                            foreach ($subitems as $subitem) {
                                ?><a <?php echo e($subitem->type); ?>="<?php echo e($subitem->link); ?>"><?php echo e($subitem->name); ?></a><?php
                            }
                            ?>  
                        </div>
                    </li> <?php 
  ...
  <!--=============== Left side End ================-->
            ...
            </style><?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>