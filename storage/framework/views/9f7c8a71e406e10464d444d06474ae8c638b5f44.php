...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(mix('assets/styles/css/themes/eva.min.css')); ?>?v=9">
    ...
    <div class='print-page'>
        ...
        <div class='print-content'  style="">
        	<div class="container-fluid" >
						<div class="row">
							<h1 class="card-title">Borrador de declaración de IVA <?php echo e(App\Variables::getMonthName($dataDeclaracion['mes'])); ?> <?php echo e($dataDeclaracion['ano']); ?> </h1>
						  <div class="col-sm-12 pl-0 pr-0">
						  	...
						  	<table class="text-12 text-muted m-0 p-2 ivas-table bigtext borrador-presentacion" style="width:100%;">
									<tbody>
									    <th>Periodo</th>
									    <td colspan="5"> <input style="width:100%;" type="text" readonly value="<?php echo e($dataDeclaracion['mes'].'/'.$dataDeclaracion['ano']); ?>" > </td>
									  </tr>
									  <tr>
									    <th>Cédula</th>
									    <td colspan="5"> <input style="width:100%;" type="text" readonly value="<?php echo e(currentCompanyModel()->id_number); ?>" > </td>
									  </tr>
									  <tr>
									    <th>Nombre o razón social</th>
									    <td colspan="5"> <input style="width:100%;" type="text" readonly value="<?php echo e(currentCompanyModel()->business_name); ?>" > </td>
									  </tr>
									</tbody>
								</table>
						  	
						  	<h2 class="card-subtitle">Consolidado</h2>
						  	<?php $__currentLoopData = $dataDeclaracion['dataActividades']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actividad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						  		<div class="declaracion-content">
						  			<h3 class="card-subtitle m-0">Actividad comercial: <?php echo e($actividad['codigo']); ?> - <?php echo e($actividad['titulo']); ?></h3>
						  			<?php echo $__env->make('Reports.widgets.declaracion.loop-actividades', ['actividad' => $actividad], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>	
						  		</div>
						  	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						  	
						  	<h2 class="card-subtitle sub2">Impuesto por ventas y transacciones sujetas</h2>
						  	<?php echo $__env->make('Reports.widgets.declaracion.ivas-ventas', ['dataDeclaracion' => $dataDeclaracion], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>	
						  	
						  	<h2 class="card-subtitle sub2">Créditos fiscales generados por compras</h2>
						  	<?php echo $__env->make('Reports.widgets.declaracion.ivas-compras', ['dataDeclaracion' => $dataDeclaracion], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>	
						  	
						  	<h2 class="card-subtitle sub2">Estimación y liquidación anual de la proporcionalidad</h2>
						  	<?php echo $__env->make('Reports.widgets.declaracion.estimacion-liquidacion', ['dataDeclaracion' => $dataDeclaracion], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>	
...
<?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views//Reports/reporte-borrador-iva.blade.php ENDPATH**/ ?>