...
<div class="form-group col-md-6">
  ...
  <input type="email" class="form-control " name="user" id="user" value="<?php echo e(@$certificate->user); ?>">
...
<div class="form-group col-md-6">
  ...
  <input type="password" class="form-control " name="password" id="password" value="<?php echo e(@$certificate->password); ?>">
</div>
...
<div class="form-group col-md-6">
  ...
  <input type="text" class="form-control " name="pin" id="pin" value="<?php echo e(@$certificate->pin); ?>">
</div>
...
<?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/wizard/pasos/paso4.blade.php ENDPATH**/ ?>