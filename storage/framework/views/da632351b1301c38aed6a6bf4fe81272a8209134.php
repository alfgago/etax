...
<div class="wizard-container">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6 hide-contador">
              ...
              <select class="form-control " name="product_id" id="product_id" onchange="togglePrice();">
                  <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($plan->plan_tier != 'Gosocket'): ?>
                    <option class="<?php echo e($plan->plan_type); ?>" facturas="<?php echo e($plan->num_invoices); ?>" value="<?php echo e($plan->id); ?>" monthly="$<?php echo e($plan->monthly_price); ?>" six="$<?php echo e($plan->six_price * 6); ?>" annual="$<?php echo e($plan->annual_price * 12); ?>" ><?php echo e($plan->plan_tier); ?></option>
                    <?php else: ?>
                      <?php if(in_array(8, auth()->user()->permisos())): ?>
                        <option class="<?php echo e($plan->plan_type); ?>" facturas="<?php echo e($plan->num_invoices); ?>" value="<?php echo e($plan->id); ?>" monthly="$<?php echo e($plan->monthly_price); ?>" six="$<?php echo e($plan->six_price * 6); ?>" annual="$<?php echo e($plan->annual_price * 12); ?>" selected><?php echo e($plan->plan_tier); ?></option>
                      <?php endif; ?>
                    <?php endif; ?>
            ...
            <div class="btn-holder">
             ...
             <?php if( !empty( auth()->user()->teams ) && !in_array(8, auth()->user()->permisos()) ): ?>
                <?php if( sizeof(auth()->user()->teams) > 1 ): ?>
  ...
  <?php if(!in_array(8, auth()->user()->permisos())): ?>
  <a class="btn btn-cerrarsesion" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();">
    Cerrar sesión
  </a>
...
<?php echo $__env->make('layouts/wizard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/subscriptions/subscription-wizard-trial.blade.php ENDPATH**/ ?>