...
<div class="row">
  <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <form method="POST" action="/quickbooks/proveedores/sync-qbaetax" class="form-row">
            <?php echo csrf_field(); ?>
...
<script>
    ...
    $(function() {
      datatable = $('#dataTable').DataTable({
        ...
        serverSide: true,
        ajax: {
          url: "/quickbooks/proveedores/data-qbaetax",
          type: 'GET'
        },
        order: [[ 1, 'asc' ]],
        columns: [
...
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/Quickbooks/Providers/sync.blade.php ENDPATH**/ ?>