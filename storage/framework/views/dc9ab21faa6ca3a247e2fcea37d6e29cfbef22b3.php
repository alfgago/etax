            ...
            <div class="form-group col-md-12">
                <div class="description">
                    ...
                    * El orden puede variar, mantener nombres de columnas. Debe utilizar una fila por cada producto.
                    <br>
                    <a href="<?php echo e(asset('assets/files/PlantillaProductos.xlsx')); ?>" class="btn btn-link" title="Descargar plantilla" download><i class="fa fa-file-excel-o" aria-hidden="true"></i> Descargar plantilla</a>
                </div>
            </div>
            <div class="form-group col-md-12">
...
<?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/Product/import.blade.php ENDPATH**/ ?>