  	...
  	<div class="tabbable verticalForm">
            ...
            <div class="col-sm-3">
                <ul class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
    				...
    				foreach ($items as $item) { ?>
    					<li>
    						<a class="nav-link" aria-selected="false"  style="color: #ffffff;" <?php echo e($item->type); ?>="<?php echo e($item->link); ?>"><?php echo e($item->name); ?></a>
    					</li>
    				<?php } ?>
                </ul>
        ...
        <div class="col-sm-9">
          <div class="tab-content">       
    		...
    		<form method="POST" action="/quickbooks/guardar-config/<?php echo e(currentCompanyModel()->id); ?>">
    			  ...
    			  <div class="form-row">
    			    ...
    			    <div class="form-group col-md-6">
    			      ...
    			      <input class="form-control" name="" type="text" placeholder="Presione el botón de autenticar" disabled value="<?php echo e($qb->authorization_code); ?>">
    			    </div>
    			    
    			    <div class="form-group col-md-6">
    			      <label for="realm_id">Código de instancia QB</label>
    			      <input class="form-control" name="" type="text" placeholder="Presione el botón de autenticar" disabled value="<?php echo e(isset($qb->realm_id) ? decrypt($qb->realm_id) : ''); ?>">
    			    </div>
    			    
    			    <div class="form-group col-md-12">
    			     <?php if( isset($qb->authorization_code) ): ?>
    			          <a style="background: #bbb;  border: 0;" class="btn btn-primary btn-success" href="<?php echo e($authUrl); ?>">Re-autenticar Quickbooks</a>
    			          <p style="color: green;">Ya se encuentra autorizado correctamente. No es necesario re-autenticar.</p>
    			     <?php else: ?>
    			         <a style="background: #4CAF50;  border: 0;" class="btn btn-primary btn-success" href="<?php echo e($authUrl); ?>">Autenticar Quickbooks</a>
    			     <?php endif; ?>
    			    </div>
...
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/Quickbooks/config.blade.php ENDPATH**/ ?>