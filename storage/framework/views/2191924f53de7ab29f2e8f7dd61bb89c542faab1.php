...
<body>
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="title" style="width: 180px; height: 100px">
                <div style="font-size: 23x; line-heiht: 1; max-width: 100%;"><?php echo e($data_bill->provider_first_name); ?> <?php echo e($data_bill->provider_last_name); ?></div>
            </td>
            <td>
                <b><?php echo e($data_bill->provider_first_name); ?> <?php echo e($data_bill->provider_last_name); ?></b><br>
                <b>Cedula:</b> <?php echo e($data_bill->provider_id_number); ?><br>
                <b>Tel:</b> <?php echo e($data_bill->provider_phone); ?><br>
                <b>Correo: <?php echo e($data_bill->provider_email); ?></b> <br>
            </td>
            <td style="padding: 40px 0px 0px 30px; text-align: right;">
                <b>Direccion:</b>
                <?php echo e($data_bill->provider_address); ?><br>
            </td>
        </tr>
        </td>
        </tr>
    ...
    <table width="100%">
        <tr class="details">
            <td style="width: 40%;margin-top: 0.75% !important;">
                <b>Receptor: <b><?php echo e($company->business_name); ?></b><br>
                <b>Cédula: </b> <?php echo e($company->_id_number); ?><br>
                <b>Tel: </b> <?php echo e($company->phone); ?><br>
                <b>Correo: </b> <?php echo e($company->email); ?><br>
                <b>Dirección: </b> <?php echo e($company->address); ?><br>
            </td>

            <td style="width: 42%;margin-top: 0.75% !important;">
                <b>Documento N°: </b><?php echo e($data_bill->document_number); ?> <br>
                <b>Clave Numérica: </b> <?php echo e($data_bill->document_key); ?><br>
                <b>Tipo de Documento: </b> <?php echo e($documentType); ?><br>
                <b>Fecha de Emisión: </b> <?php echo e($data_bill->generated_date); ?><br>
                <b>Condición Venta: </b> <?php echo e($data_bill->getCondicionVenta()); ?><br>
                <b>Medio de Pago: </b> <?php echo e($data_bill->getMetodoPago()); ?><br>
            </td>
        </tr>
    </table>
    ...
    ?>
    <?php $__currentLoopData = $data_bill->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr class="item">
            <td>
            ...
            <td>
                <?php echo e($item->discount ? number_format($item->discount, 0) : '0'); ?>

            </td>
            <td>
                <?php echo e(isset($item->discount_type) ? $item->discount_type == '01' ? '%' : 'monto': ''); ?>
            ...
            <td style="width: 50%;">
                ...
                <table class="resumen-totales">
                    ...
                    <tr>
                        ...
                        <td><span><?php echo e(number_format( ($totalComprobante - $totalIvaDevuelto) , 2)); ?></span></td>
                    </tr>
                </table>
...
<?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/Pdf/bill.blade.php ENDPATH**/ ?>