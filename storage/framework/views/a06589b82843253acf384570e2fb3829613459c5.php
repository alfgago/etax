...
<div class="row">
  <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <form method="POST" action="/quickbooks/clientes/sync-etaxaqb" class="form-row">
            <?php echo csrf_field(); ?>
...
<script>
    ...
    $(function() {
      datatable = $('#dataTable').DataTable({
        ...
        serverSide: true,
        ajax: {
          url: "/quickbooks/clientes/data-etaxaqb",
          type: 'GET'
        },
        order: [[ 2, 'asc' ]],
        columns: [
...
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/Quickbooks/Clients/sync-qb.blade.php ENDPATH**/ ?>