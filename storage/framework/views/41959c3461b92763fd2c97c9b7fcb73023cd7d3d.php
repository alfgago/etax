<div class="popup" id="importar-clientes-popup">
		  ...
		  <div class="form-group col-md-12">
			  <div class="description">
			  	...
			  	* El orden puede variar, mantener nombres de columnas. Debe utilizar una fila por cada cliente.
			  	<br>
			  	<a href="<?php echo e(asset('assets/files/PlantillaClientes.xlsx')); ?>" class="btn btn-link" title="Descargar plantilla" download><i class="fa fa-file-excel-o" aria-hidden="true"></i> Descargar plantilla</a>
			  </div>
		  </div>
...
<?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/Client/import.blade.php ENDPATH**/ ?>