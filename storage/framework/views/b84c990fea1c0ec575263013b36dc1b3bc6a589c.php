<?php $__env->startComponent('mail::layout'); ?>
    ...
    <?php $__env->slot('header'); ?>
        <?php $__env->startComponent('mail::header', ['url' => config('app.url'), 'customImg' => @$customImg]); ?>
...
<?php echo $__env->renderComponent(); ?>
    ...
    <?php $__env->slot('footer'); ?>
        <?php $__env->startComponent('mail::footer'); ?>
            © <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. <?php echo app('translator')->get('Derechos reservados.'); ?>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/vendor/mail/html/message.blade.php ENDPATH**/ ?>