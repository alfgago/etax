<div class="popup" id="nuevo-cliente-popup">
  <div class="popup-container nuevo-cliente-form form-row">
    ...
    <div class="form-group col-md-4">
      ...
      <?php if(@$document_type == '01' || @$document_type == '08'): ?>
        <option value="F" >Física</option>
        <option value="J" >Jurídica</option>
        <option value="D" >DIMEX</option>
        <option value="N" >NITE</option>
      <?php elseif(@$document_type == '04' || @$document_type == ''): ?>
        <option value="F" >Física</option>
        <option value="J" >Jurídica</option>
        <option value="D" >DIMEX</option>
        <option value="N" >NITE</option>
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control <?php if(@$document_type !== '04'): ?> checkEmpty <?php endif; ?>" name="id_number" id="id_number" onchange="getJSONCedula(this.value);" maxlength="20">
    </div>
    
    <div class="form-group col-md-4">
      <label for="first_name">Nombre *</label>
      <input type="text" class="form-control <?php if(@$document_type !== '04'): ?> checkEmpty <?php endif; ?>" name="first_name" id="first_name" maxlength="80">
    </div>
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control <?php if(@$document_type !== '04'): ?> checkEmpty <?php endif; ?>" name="email" id="email" onblur="validateEmail();" maxlength="160">
    </div>
    ...
    <div class="form-group col-md-4">
      ...
      <select class="form-control <?php if(@$document_type !== '04'): ?> checkEmpty <?php endif; ?>" name="country" id="country" >
    ...
    <?php if(@$document_type != '09'): ?>
      <div class="form-group col-md-4" id="divState">
        ...
        <select class="form-control <?php if(@$document_type !== '04'): ?> checkEmpty <?php endif; ?>" name="state" id="state" onchange="fillCantones();">
        </select>
      </div>

      <div class="form-group col-md-4" id="divCity">
        <label for="city">Canton *</label>
        <select class="form-control <?php if(@$document_type !== '04'): ?> checkEmpty <?php endif; ?>" name="city" id="city" onchange="fillDistritos();">
        </select>
      </div>

      <div class="form-group col-md-4" id="divDistrict">
        <label for="district">Distrito *</label>
        <select class="form-control <?php if(@$document_type !== '04'): ?> checkEmpty <?php endif; ?>" name="district" id="district" onchange="fillZip();" >
        </select>
      </div>
...
<?php /**PATH /home/237808.cloudwaysapps.com/ducfpkkugc/public_html/resources/views/Invoice/form-nuevo-cliente.blade.php ENDPATH**/ ?>