...
class CreateLineaFacturaEmitidasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('linea_factura_emitidas', function (Blueprint $table) {
            $table->bigIncrements('id');
          
            $table->unsignedBigInteger('factura_emitida_id');
    ...
    {
        Schema::dropIfExists('linea_factura_emitidas');
    }
}
