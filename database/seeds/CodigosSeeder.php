...
class CodigosSeeder extends Seeder
{
    ...
    public function runRepercutidos() {
        ...
        $lista = [
          ...
          ['nombre'=>'B245 - Ventas locales de bienes con tarifa transitoria del 0% sin derecho a crédito', 'hide'=>true, 'codigo'=>'B245', 'porcentaje'=>'0', 'codigo_tarifa' => '01', 'is_bienes'=>true, 'is_gravado'=>false], //*vigente del 1-07-2019 al 30-06-2020
