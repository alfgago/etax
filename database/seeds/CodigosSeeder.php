...
class CodigosSeeder extends Seeder
{
    ...
    public function runSoportados() {
        $lista = [
          ...
          ['nombre'=>'B014 - Compras locales de bienes de capital con IVA al 4% sin identificación específica', 'codigo'=>'B014', 'porcentaje'=>'4', 'is_servicio'=>true, 'hide'=>true],
          ...
          ['nombre'=>'B024 - Importaciones de bienes con IVA al 4% sin identificación específica', 'codigo'=>'B024', 'porcentaje'=>'4', 'is_bienes'=>true, 'is_importacion'=>true, 'hide'=>true],
          ...
          ['nombre'=>'B034 - Importaciones de bienes de capital con IVA al 4% sin identificación específica', 'codigo'=>'B034', 'porcentaje'=>'4', 'is_servicio'=>true, 'is_importacion'=>true, 'hide'=>true],
          ...
          ['nombre'=>'B054 - Importaciones con IVA al 4% de bienes de capital de acreditación plena con identificación específica', 'codigo'=>'B054', 'porcentaje'=>'4', 'is_servicio'=>true, 'is_importacion'=>true, 'is_identificacion_plena'=>true, 'hide'=>true],
          
          ['nombre'=>'B060 - Compras locales de bienes y servicios exentos y no sujetos.', 'codigo'=>'B060', 'porcentaje'=>'0', 'is_bienes'=>true],
          ...
          ['nombre'=>'B074 - Compras locales con IVA al 4% de bienes de capital de acreditación plena con identificación específica.', 'codigo'=>'B074', 'porcentaje'=>'4', 'is_servicio'=>true, 'is_identificacion_plena'=>true, 'hide'=>true],
          ...
          ['nombre'=>'S021 - Importaciones de servicios con IVA al 1% sin identificación específica', 'codigo'=>'S021', 'porcentaje'=>'1', 'is_servicio'=>true, 'is_importacion'=>true, 'hide'=>true],
          ['nombre'=>'S022 - Importaciones de servicios con IVA al 2% sin identificación específica', 'codigo'=>'S022', 'porcentaje'=>'2', 'is_servicio'=>true, 'is_importacion'=>true, 'hide'=>true],
          ...
          ['nombre'=>'S024 - Importaciones de servicios con IVA al 4% sin identificación específica', 'codigo'=>'S024', 'porcentaje'=>'4', 'is_servicio'=>true, 'is_importacion'=>true, 'hide'=>true],

          //Con identificación específica
          ['nombre'=>'S040 - Importaciones de servicios exentos', 'codigo'=>'S040', 'porcentaje'=>'0', 'is_servicio'=>true, 'is_importacion'=>true],
          ['nombre'=>'S041 - Importaciones con IVA al 1% de servicios de acreditación plena con identificación específica', 'codigo'=>'S041', 'porcentaje'=>'1', 'is_servicio'=>true, 'is_importacion'=>true, 'is_identificacion_plena'=>true, 'hide'=>true],
          ['nombre'=>'S042 - Importaciones con IVA al 2% de servicios de acreditación plena con identificación específica', 'codigo'=>'S042', 'porcentaje'=>'2', 'is_servicio'=>true, 'is_importacion'=>true, 'is_identificacion_plena'=>true, 'hide'=>true],
          ...
          ['nombre'=>'S044 - Importaciones con IVA al 4% de servicios de acreditación plena con identificación específica', 'codigo'=>'S044', 'porcentaje'=>'4', 'is_servicio'=>true, 'is_importacion'=>true, 'is_identificacion_plena'=>true, 'hide'=>true],
    ...
    public function runRepercutidos() {
        ...
        $lista = [
          ...
          ['nombre'=>'B114 - Ventas locales de bienes con tarifa transitoria del 4% con derecho a crédito  *vigente del 1-07-2020 al 30-06-2021', 'codigo'=>'B114', 'porcentaje'=>'4', 'hide'=>false, 'hidden2018'=>true, 'codigo_tarifa' => '06', 'is_bienes'=>true, 'is_gravado'=>true],
          ...
          ['nombre'=>'B181 - Ventas de bienes a no sujetos y exentos con derecho a crédito al 1%', 'codigo'=>'B181', 'porcentaje'=>'1', 'codigo_tarifa' => '02', 'is_bienes'=>true, 'is_gravado'=>true],
          ['nombre'=>'B182 - Ventas de bienes a no sujetos y exentos con derecho a crédito al 2%', 'codigo'=>'B182', 'porcentaje'=>'2', 'codigo_tarifa' => '03', 'is_bienes'=>true, 'is_gravado'=>true],
          ['nombre'=>'B183 - Ventas de bienes a no sujetos y exentos con derecho a crédito al 13%', 'codigo'=>'B183', 'porcentaje'=>'13', 'codigo_tarifa' => '08', 'is_bienes'=>true, 'is_gravado'=>true],
          ['nombre'=>'B184 - Ventas de bienes a no sujetos y exentos con derecho a crédito al 4%', 'codigo'=>'B184', 'porcentaje'=>'4', 'codigo_tarifa' => '04', 'is_bienes'=>true, 'is_gravado'=>true],
          ...
          ['nombre'=>'S114 - Ventas locales de servicios con tarifa transitoria del 4% con derecho a crédito  *vigente del 1-07-2020 al 30-06-2021', 'codigo'=>'S114', 'porcentaje'=>'4', 'hide'=>false, 'hidden2018'=>true, 'codigo_tarifa' => '06', 'is_servicio'=>true, 'is_gravado'=>true],
          ...
          ['nombre'=>'S130 - Ventas de servicios con límites sobrepasados al 13% con derecho a crédito', 'codigo'=>'S130', 'porcentaje'=>'13', 'hide'=>true, 'hidden2018'=>true, 'codigo_tarifa' => '08', 'is_servicio'=>true, 'is_gravado'=>true],
          ...
          ['nombre'=>'S155 - Ventas de servicios con derecho a crédito por ventas con IVA recaudado desde aduanas.', 'codigo'=>'S155', 'porcentaje'=>'0', 'codigo_tarifa' => '01', 'is_servicio'=>true, 'is_gravado'=>true, 'hide'=>true ],
          ...
          ['nombre'=>'S181 - Ventas de servicios a no sujetos y exentos con derecho a crédito al 1%', 'codigo'=>'S181', 'porcentaje'=>'1', 'codigo_tarifa' => '02', 'is_servicio'=>true, 'is_gravado'=>true],
          ['nombre'=>'S182 - Ventas de servicios a no sujetos y exentos con derecho a crédito al 2%', 'codigo'=>'S182', 'porcentaje'=>'2', 'codigo_tarifa' => '03', 'is_servicio'=>true, 'is_gravado'=>true],
          ['nombre'=>'S183 - Ventas de servicios a no sujetos y exentos con derecho a crédito al 13%', 'codigo'=>'S183', 'porcentaje'=>'13', 'codigo_tarifa' => '08', 'is_servicio'=>true, 'is_gravado'=>true],
          ['nombre'=>'S184 - Ventas de servicios a no sujetos y exentos con derecho a crédito al 4%', 'codigo'=>'S184', 'porcentaje'=>'4', 'codigo_tarifa' => '04', 'is_servicio'=>true, 'is_gravado'=>true],
